...
var questions = [
	...
	[
		...
		'<form onsubmit="showQuestion9(questions, user);">Sleep de eigenschappen (rechts) naar de bijbehorende prioriteit (links). <br/> De eigenschappen die het belangrijkst voor u zijn, staan het dichtst bij u (gele cirkel) <br/> en de eigenschappen die u minder belangrijk vind staan verder van u af (paarse cirkel). <br/> Druk op \'Reset\' om overnieuw te beginnen. <br/> <div id="place-attachment"> <div id="place-attachment-drop"> <div id="place-attachment-drop5" ondrop="dropPlaceAttachment(event, user)" ondragover="allowDrop(event)"> Prioriteit 5 <div id="place-attachment-drop4" ondrop="dropPlaceAttachment(event, user)" ondragover="allowDrop(event)"> Prioriteit 4 <div id="place-attachment-drop3" ondrop="dropPlaceAttachment(event, user)" ondragover="allowDrop(event)"> Prioriteit 3 <div id="place-attachment-drop2" ondrop="dropPlaceAttachment(event, user)" ondragover="allowDrop(event)"> Prioriteit 2 <div id="place-attachment-drop1" ondrop="dropPlaceAttachment(event, user)" ondragover="allowDrop(event)"> Prioriteit 1 <div id="place-attachment-you"> U </div> </div> </div> </div> </div> </div> </div> <div id="place-attachment-drag"> <div id="place-attachment-drag-title"> <b>Eigenschappen</b> <div id="place-attachment-drag-item-wrapper"> <div id="place-attachment-drag-place-identity" class="place-attachment-drag-item" draggable="true" ondragstart="drag(event)"> Identiteit </div> <div id="place-attachment-drag-place-dependency" class="place-attachment-drag-item" draggable="true" ondragstart="drag(event)"> <u title="De mogelijkheden die de stad biedt.">Mogelijkheden</u> </div> <div id="place-attachment-drag-nature-bonding" class="place-attachment-drag-item" draggable="true" ondragstart="drag(event)"> Natuur </div> <div id="place-attachment-drag-family-bonding" class="place-attachment-drag-item" draggable="true" ondragstart="drag(event)"> Familie </div> <div id="place-attachment-drag-friend-bonding" class="place-attachment-drag-item" draggable="true" ondragstart="drag(event)"> Vrienden </div> </div> </div> <div id="place-attachment-drag-reset" onclick="resetPlaceAttachment(user)"> Reset </div> <br/> <input type="submit" value="Volgende"> <br/><br/> </div> </div></form>',
		''
	],
	[
		"cartoon-question9",
